...
import com.shamardn.android.marvelcomics.ui.screen.characterDetails.StoryDetailsScreen
...
import com.shamardn.android.marvelcomics.ui.screen.stories.StoriesScreen
...
fun MarvelNavGraph(navController: NavHostController) {
    NavHost(navController = navController, startDestination = Screen.Home.route) {
        ...
        composable("${Screen.Stories.route}/{id}/{idType}",
            arguments = listOf(
                navArgument(name = "id") { NavType.IntType},
                navArgument(name = "idType") { NavType.IntType},
            ))
        ...
        composable("${Screen.StoryDetails.route}/{id}",
            arguments = listOf(navArgument(name = "id") { NavType.IntType}, ))
